...
dt_contratos_clean <- dt_contratos_csv |>
  ...
  select(CODIGOCONVOCATORIA, RUCENTIDAD, ENTIDADCONTRATANTE, NUMITEM, MONTOREFERENCIALTOTAL, MONTOCONTRATADOTOTAL, MONTOCONTRATADOITEM, FECHASUSCRIPCIONCONTRATO,FECHAVIGENCIAINICIAL,FECHAVIGENCIAFINAL,FECHAVIGENCIAFINACTUALIZADA) |>
  rbind(dt_contratos_xls |>
          select(CODIGOCONVOCATORIA, RUCENTIDAD, ENTIDADCONTRATANTE, NUMITEM, MONTOREFERENCIALTOTAL, MONTOCONTRATADOTOTAL, MONTOCONTRATADOITEM, FECHASUSCRIPCIONCONTRATO,FECHAVIGENCIAINICIAL,FECHAVIGENCIAFINAL,FECHAVIGENCIAFINACTUALIZADA), fill = TRUE)
