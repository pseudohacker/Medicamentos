...
```{r}
dt_contratos <- readRDS(file = "dt_contratos.Rds")
dt_postores <- readRDS(file = "dt_postores.Rds")
dt_convocatorias <- readRDS(file = "dt_convocatorias.Rds")
dt_participantes <- readRDS(file = "dt_participantes.Rds")
